...
function generateHubPage() {
    ...
    <div class="max-w-6xl mx-auto px-6">
      <div class="max-w-3xl mb-16">
        ...
        <p class="text-lg text-slate-600 dark:text-zinc-500">100 entries on creatine supplementation. Entries include cited sources for readers to verify.</p>
      </div>
...
${articleGrid}
    ...
    return pageShell(
        'Articles',
        `${totalArticles} research-grade articles on creatine supplementation. Entries include cited sources for readers to verify.`,
        '/articles',
        body
    );
}
...
${articleList}
      ...
      <div class="mt-16 p-8 bg-white dark:bg-zinc-900/30 border border-slate-200 dark:border-zinc-800/60 rounded-xl text-center">
        ...
        <p class="text-slate-600 dark:text-zinc-500 mb-6">Entries include cited sources for readers to verify. Get notified when new entries are published.</p>
